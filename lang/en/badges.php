...
$string['criteria_not_found_description'] = 'This criterion uses the \'{$a}\' criteria type but the plugin could not be found.';
$string['criteria_not_found_description_short'] = 'Missing criteria \'{$a}\'';
...
$string['error:criteriatypenotfound'] = 'This criterion uses the \'{$a}\' criteria type but the plugin could not be found. Either add the plugin code to the badges/criteria/ folder or delete this criterion.';
...
$string['error:missingoverallcriteriatype'] = 'The \'overall\' criteria type is missing from the code.';
...
$string['fixcriteria'] = 'Fix criteria';
$string['fixed'] = 'Fixed date';
$string['hidden'] = 'Hidden';
$string['hiddenbadge'] = 'Unfortunately, the badge owner has not made this information available.';
$string['invalidcriteria'] = 'This badge has some invalid criteria.';
$string['invalidcriteria_descr'] = 'The criteria \'{$a}\' could not be found in the code';
$string['invalidcriteria_descr_full'] = 'The criteria \'{$a}\' could not be found in the code. To fix the problem add the \'{$a}\' badge criteria plugin to the badges/criteria folder on your site.';
$string['invalidcriteria_descr_short'] = 'Criteria \'{$a}\' not found';
